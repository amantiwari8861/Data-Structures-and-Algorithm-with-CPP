...
public class LinkedQueues
{
		...
		public final void insert(int element) // Inserts node in the queue
		{
			Node newnode;
		...
		public final void remove() // Deletes node from the queue
		{
		...
		public final void display() // displays the elements of the queue
		{
			Node tmp;
